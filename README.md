...
<details>
<summary><strong><a href="https://github.com/ZyanWan/Skill-Hub">Skill-Hub</a></strong> · <code>Python</code> — An Agent Skills library and management system with 367 standardized skill packages across 12 categories</summary>

An Agent Skills library and management system for AI coding assistants, containing 367 standardized skill packages across 12 categories, covering mainstream assistants such as Claude Code / Cursor / Codex / Gemini CLI; it comes with a zero-dependency CLI (skill-tool.py) and a local visual Skill Manager platform (React + Fastify).
...
A real browser automation skill layer for AI agents: based on Patchright, it encapsulates persistent sessions, page probing, controlled operations, and evidence retention; it can be distributed to Codex / Claude Code via an npm installer and supports packaging standalone skills by business domain.

</details>

<details>
<summary><strong><a href="https://github.com/ZyanWan/Session-Engram">Session-Engram</a></strong> · <code>Python</code> — A cross-session memory system based on Hook mechanisms</summary>

A cross-session memory system for AI coding assistants: it uses Markdown to persist sessions and reusable experience, and based on Hook mechanisms, it lets AI automatically read memory at the start of a new session; built-in interactive knowledge graph, timeline, and global experience library, supporting Claude Code / OpenCode / Cursor.
...
A modern AI Agent platform product prototype: five modules including chat, MCP management, Agent configuration, visual workflow canvas (ReactFlow), and knowledge base; built with Vite + React 18 + Zustand + Tailwind CSS v4, supporting dark / light themes.
...
A Chinese character etymology animation tool for teaching Chinese as a foreign language: it automatically fetches character form data from oracle bone script to regular script, generates continuous evolution animations via Alibaba Cloud Wan2.7, and adds Volcano Engine TTS voice narration to help students understand why Chinese characters look the way they do today.
